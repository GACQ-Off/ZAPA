...
// 2. Consulta para obtener los detalles de los productos vendidos
...
// 3. Consulta para obtener los detalles de los pagos
...
// 4. Consulta para obtener detalles de crédito (si aplica)
$credito_venta = null;
...
<head>
    ...
    <style>
       ...
       .container { width: 900px; background-color: #fff; padding: 10px; border-radius: 8px; box-shadow: 0 2px 15px rgba(0,0,0,0.1); }
...
<?php include "../assets/lista_gerente.php"?>
    ...
    <div class="container">
        ...
        <a href="lista_ventas.php" class="back-link">Volver al Listado de Ventas</a>
    </div>
