...
if (!isset($_GET['Categoria']) || empty($_GET['Categoria'])) {
    $error_message = "Error: No se especificó el id de la categoría de gasto.";
} else {
    ...
    if (!isset($conn) || $conn->connect_error) {
        ...
        $sql = "UPDATE categoria_gasto SET estado_categoria_gasto = 2 WHERE id_categoria_gasto = ?";
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                $error_message = "Error al intentar eliminar la categoría de gasto: " . $stmt->error;
            }
            $stmt->close();
        } else {
...
<head>
    ...
    <title>Eliminar Categoría de Gasto</title>
...
<?php if ($show_modal): ?>
    <div id="successModal" class="modal">
        <div class="modal-content">
            ...
            <h2>Éxito</h2>
            <p>Categoría de gasto eliminada con éxito.</p>
        </div>
    </div>
<?php endif; ?>
