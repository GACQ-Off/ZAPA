...
<body>
    ...
    <div class="container">
        ...
        <?php else: ?>
            <p>Por favor, seleccione un crédito desde el <a href="credito_ventas.php">historial de créditos</a> para ver sus detalles y realizar abonos.</p>
        <?php endif; ?>
        <br>
        <a href="credito_ventas.php" class="btn" style="margin-top: 20px;">Volver al Historial de Créditos</a>
    </div>
</body>
</html>