<?php 
	...
	if(!empty($_POST))
	{
		...
		{//#2980B9 azul
			...
			$query = mysqli_query($conexion,"SELECT * FROM Usuario WHERE (Usuario = '$Usuario' AND Cedula_Usuario !='$Cedula') OR (Correo_Usuario = '$Correo' AND Cedula_Usuario !='$Cedula') ");
			...
			{	if(empty($_POST['Clave']))
				{
					$sql_Actualizar=mysqli_query($conexion, "UPDATE Usuario SET Nombres_Usuario='$Nombres',Apellidos_Usuario='$Apellidos', Telefono_Usuario='$Telefono', Correo_Usuario='$Correo', Usuario='$Usuario',Codigo_Tipo_Usuario='$Tipo_Usuario' WHERE Cedula_Usuario=$Cedula");
				}
				else
				{
					$sql_Actualizar=mysqli_query($conexion, "UPDATE Usuario SET Nombres_Usuario='$Nombres',Apellidos_Usuario='$Apellidos', Telefono_Usuario='$Telefono', Correo_Usuario='$Correo', Usuario='$Usuario',Clave_Usuario='$Clave',Codigo_Tipo_Usuario='$Tipo_Usuario'
