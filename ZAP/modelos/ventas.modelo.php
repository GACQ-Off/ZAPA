...
class ModeloVentas{
    ...
    * =============================================*/
    ...
    factura, tipo_ced_cliente, num_ced_cliente, vendedor, 
    tipo_rif_empresa, num_rif_empresa, total, metodo_pago, 
    fecha, pago, impuesto) 
VALUES (
    :factura, :tipo_ced, :num_ced, :vendedor, 
    :tipo_rif, :num_rif, :total, :metodo_pago, 
    NOW(), :pago, :impuesto)");
	...
	$stmt->bindParam(":tipo_ced", $datos["tipo_ced_cliente"], PDO::PARAM_STR);
	$stmt->bindParam(":num_ced", $datos["num_ced_cliente"], PDO::PARAM_STR);
