...
$ancho_texto_fijo = $pdf->GetStringWidth('Fecha:');

// Calcular la posición X para alinear el nombre a la derecha
$pdf->SetX(180 - $ancho_texto_fijo); // Ajusta 180 según el ancho de tu página
