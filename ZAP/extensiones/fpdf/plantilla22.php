...
$this->Cell(40, 8,"Reporte de Inventario");
...
$pdf->Cell(27, 12, utf8_decode('Codigo'),1,0,'C',1);
$pdf->Cell(45, 12, utf8_decode('Descripcion'),1,0,'C',1);
$pdf->Cell(45, 12, utf8_decode('Categoria'),1,0,'C',1);
$pdf->Cell(25, 12, utf8_decode('Tipo'),1,0,'C',1);
$pdf->Cell(30, 12, utf8_decode('Marca'),1,1,'C',1);
$pdf->Cell(30, 12, utf8_decode('Color'),1,1,'C',1);
$pdf->Cell(30, 12, utf8_decode('Stock'),1,1,'C',1);
$pdf->Cell(30, 12, utf8_decode('P. Compra'),1,1,'C',1);
$pdf->Cell(30, 12, utf8_decode('P. Venta'),1,1,'C',1);
