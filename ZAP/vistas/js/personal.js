...
$(".tablas").on("click", ".btnEliminarUsuario", function(){
  ...
  swal({
    ...
    if(result.value){
      ...
      window.location = "index.php?ruta=personal&idUsuario="+idUsuario+"&usuario="+usuario+"&fotoUsuario="+fotoUsuario;
