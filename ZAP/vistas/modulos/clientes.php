  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn-lg btn-primary" onclick="window.location.href = 'extensiones/fpdf/reporteClientesFPDF.php';">
...
$valor = null;
        ...
        foreach ($clientes as $key => $value) {
          ...
          echo '<td>' . ucwords($value["direccion"]) . '</td>
                <td>
                  <div class="btn-group">
                    <button class="btn btn-warning btnEditarCliente" tipoCedula="' . $value["tipo_ced"] . '" numCedula="' . $value["num_ced"] . '" data-toggle="modal" data-target="#modalEditarUsuario"><i class="fa fa-pencil"></i></button>
                    ' . $buttons . '
                  </div>  
                </td>
              </tr>';
...
<div class="form-group">
  <div class="input-group">
    ...
    <!-- Tipo de cédula -->
    <select class="form-control input-lg" id="selectTipoCedula" name="tipoCedula" style="width: 80px; margin-right: 5px;" required>
    ...
    <!-- Número de cédula -->
    <input type="text" class="form-control input-lg" id="inputNumeroCedula" name="numeroCedula"
      ...
      <form role="form" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
                                         ...
                                         <!-- CAMPOS OCULTOS PARA LA CÉDULA ORIGINAL -->
                  <!-- INPUTS OCULTOS PARA ENVIAR LA CÉDULA (clave primaria) -->
        <input type="hidden" id="originalTipoCedula" name="original_tipo_ced">
        <input type="hidden" id="originalNumCedula" name="original_num_ced">
        <input type="hidden" id="cedulaOriginalParaEdicion" name="cedulaOriginalParaEdicion">

        <!-- CÉDULA VISIBLE SOLO PARA LECTURA -->
        <a><b>Cédula del Cliente</b></a>
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-id-card-o"></i></span>
            <input type="text" id="editarCedulaDisplay" class="form-control input-lg" name="editarCedula" readonly>
          </div>
        </div>
...
<div class="form-group">
  <div class="input-group">
    ...
    <input
      type="text"
      name="editarNumeroTelefono"
      class="form-control input-lg"
      id="editarNumeroTelefono"
      placeholder="Ej: 1234567"
      required
      minlength="7"
      maxlength="7"
      pattern="[0-9]{7}"
      oninput="validarEditarNumeroTelefono()"
      oninvalid="this.setCustomValidity('Los 7 dígitos del teléfono solo pueden contener números.')"
      style="flex-grow: 1;"
    >
  </div>
...
<!-- SCRIPT -->
<script>
  function validarEditarNumeroTelefono() {
    const input = document.getElementById('editarNumeroTelefono');
    const regex = /^[0-9]{7}$/;
