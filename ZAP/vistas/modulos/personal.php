  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn-lg btn-primary" data-toggle="modal" data-target="#modalAgregarEmpleado">
       ...
       foreach ($empleados as $key => $value){
          ...
          echo ' <tr>
                ...
                ($value["cedula"] == '1000000' ?
                    '<button class="btn btn-warning" disabled style="cursor: not-allowed;" title="No se puede editar al Administrador"><i class="fa fa-pencil"></i></button>
                    <button class="btn btn-danger" disabled style="cursor: not-allowed; margin-left: 5px;" title="No se puede eliminar al Administrador"><i class="fa fa-times"></i></button>'
                    :
...
<div class="form-group">
  <div class="input-group">
    ...
    <select class="form-control input-lg" id="selectPrefijoTelefono" name="prefijo_telefono" style="width: 100px; margin-right: 5px;" required>
    ...
    <input type="text" class="form-control input-lg" id="inputRestoTelefono" name="numero_telefono" placeholder="Ej: 1234567" required minlength="7" maxlength="7" pattern="[0-9]{7}"
    ...
    <script>
      ...
      function validarRestoTelefono() {
        ...
        // Se ha eliminado la llamada a combinarTelefono()
      }
    </script>
  </div>
</div>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" id="nuevaCedula" class="form-control input-lg" name="editarCedula" placeholder="Ingresar cédula" readonly required>
