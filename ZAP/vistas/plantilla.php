   ...
   echo '<div class="wrapper">';
    ...
    if(isset($_GET["ruta"])){
       ...
       if($_GET["ruta"] == "inicio" ||
           ...
           $_GET["ruta"] == "crear-ventav2" ||
           $_GET["ruta"] == "editar-venta" ||
           $_GET["ruta"] == "reporte-v" ||
           $_GET["ruta"] == "apartado" ||
           $_GET["ruta"] == "crear-apartado" ||
           $_GET["ruta"] == "editar-apartado" ||
           $_GET["ruta"] == "reporte-a" ||
           $_GET["ruta"] == "reporte-t" ||
           $_GET["ruta"] == "proveedor" ||
        ...
        if($_GET["ruta"] == "ventas"){
          echo "<script src='vistas/js/crear-venta.js'></script>";
...
<script>
  window.addEventListener("unload", function () {
    navigator.sendBeacon("salir.php");
  });
</script>
