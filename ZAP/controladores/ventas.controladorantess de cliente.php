...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		if(isset($_POST["nuevaVenta"])){
			...
			$datosVenta = array("vendedor"=>$_POST["idVendedor"],
			...
			if($respuesta == "ok"){
				...
				$logData = array(
					...
					"description" => "Nueva venta registrada. Factura: {$datosVenta['factura']}, Cliente: {$datosVenta['cliente']}, Total: {$datosVenta['total']}.",
					"employee_cedula" => $empleadoCedula,
					"affected_table" => "ventas",
