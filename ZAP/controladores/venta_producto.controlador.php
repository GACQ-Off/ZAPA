...
class ControladorVentasProductos{

	/*=============================================
	MOSTRAR VENTAS
	=============================================*/

	static public function ctrMostrarVentasProductos($item, $valor){

		$tabla = "venta_producto";

		$respuesta = ModeloVentasProducto::mdlMostrarVentasProductos($tabla, $item, $valor);
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			$rif = ControladorConfiguracion::ctrMostrarConfigracion(null,null);
			$rif = $rif["rif"];

			$datos = array("vendedor"=>$_POST["idVendedor"],
