...
$tables             = array("categorias","clientes","colores","empleado","empresas","marcas","productos","tipos","usuarios","ventas","venta_producto");
...
if(isset($_POST["exportar"])){
  ...
  {
/**
 * SYSTEMS-ADMIN frompage
 * @package SYSTEMS-ADMIN
 * @subpackage SYSTEMS-ADMIN/kernel-export
 * @copyright SystemSoftware.inc
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL V3 later
*/
//////////////////////////////////////////////////////////////////////////////////////////////////////////

/** Configuracion de la Exportacion de la Base de Datos
 *------------------------------------------------------*/
...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'zapateriak');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", './vistas/backup/'); // Comment this line to use same script's directory ('.')
...
if(isset($_GET["semanal"])){
     echo "<script>alert('Copia de seguridad semanal realizada.');</script>";
}else{
    echo "<script>alert('Respaldo ".$resultado."');</script>"; 
}
