...
/** Configuracion de importacion de la Base de Datos
 *------------------------------------------------------*/

if(isset($_POST["importar"])){

    $database = "myphp-backup-zapateriak.sql";
...
define("BACKUP_FILE", $database); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
