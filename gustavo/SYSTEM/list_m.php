        ...
        <section id="listados_">
            <div id="contenedor_de_tabla">
                <table>
                    ...
                    <tbody>
                <?php if ($materiales && count($materiales) > 0) {foreach ($materiales as $material) { 
                    $id = $material['id_material']; $tipo_registro = 'Material'; $nombre_registro = $material['nombre_material']; $iu = $_tabs_atr;    ?>
                        <tr>
                            <td>
                                <p>
