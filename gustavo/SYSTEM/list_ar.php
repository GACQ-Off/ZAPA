            ...
            <div id="contenedor_de_tabla">
                ...
                <?php if (!empty($areas)) {
                    foreach ($areas as $area) { 
                        $id = $area['id_area']; $tipo_registro = 'Área'; $nombre_registro = $area['nombre_area']; $iu = $_tabs_atr; ?>
                        <tr>
                            <td><p>
